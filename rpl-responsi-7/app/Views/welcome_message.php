...
<head>
    ...
    <style>
        .button {
            ...
            font-size: larger;
            margin-inline: auto;
            box-shadow: #ee9779 0 0 0;
            animation: glow 2s alternate infinite 200ms;
...
<body>
    ...
    <header>
        ...
        <div class="heroe">
            ...
            <a href="/products" style="margin-block: 1.245em; text-decoration: none;">
                <div class="button">Temukan Produk</div>
            </a>
